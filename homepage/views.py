...
def text_to_video(request):
	if request.method == "POST":
		...
		for i in range(len(sentences)):
			...
			print(savepath)
			current_video_clip = ImageClip(savepath).set_opacity(1).set_duration(current_audio_clip.duration).set_fps(10).crossfadein(0.5)
		...
		print("Saving Video!")
		result_with_audio.write_videofile('homepage/static/homepage/0.mp4',codec='libx264',fps=10,threads=4,preset='ultrafast')
		print("Done!")
